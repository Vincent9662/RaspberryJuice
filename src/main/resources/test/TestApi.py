...
# Get the position of player "V"
player_pos = mc.entity.getTilePos(mc.getPlayerEntityId("Salsa_Craft3r"))
...
# mc.postToChat(f"Spawning skeleton near player Vincent_Craft3r!")

# Spawn a skeleton using spawnEntity
# Entity type ID for skeleton is 51
# entity_id = mc.spawnEntity(spawn_x, spawn_y, spawn_z, 51)

# print(f"Spawned skeleton at: {spawn_x}, {spawn_y}, {spawn_z}")
# print(f"Entity ID: {entity_id}")

mc.postToChat("Hello ! No Skeleton this time")
